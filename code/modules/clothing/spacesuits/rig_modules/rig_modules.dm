...
/obj/item/rig_module/muscle_tissue
	...
	desc = "A number of sensors stretched between the surface and interior of the suit like a neural network. When these sensors detected an impact, the artificial muscle in the suit reacts instantaneously, contracting and diffusing the damage."
